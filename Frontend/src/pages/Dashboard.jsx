...
const Dashboard = () => {
  ...
  const calculateCompletion = (resume) => {
    ...
    let totalFields = 0; // Profile Info

    totalFields += 3;
    if (resume.profileInfo?.fullName) completedFields++;
    if (resume.profileInfo?.designation) completedFields++;
    if (resume.profileInfo?.summary) completedFields++; // Contact Info

    totalFields += 2;
    if (resume.contactInfo?.email) completedFields++;
    if (resume.contactInfo?.phone) completedFields++; // Work Experience
        ...
        {!loading && allResumes.length === 0 && (
          <div className={styles.emptyStateWrapper}>
            <div className={styles.emptyIconWrapper}>
              <LucideFilePlus size={32} className="text-blue-500" />
            </div>
            <h3 className={styles.emptyTitle}>No Resume Yet</h3>

            <p className={styles.emptyText}>
              You have not created any Resume yet. Start building your 
              professional job-ready resume to get your dream job 😊. 
            </p>
      ...
      >
        <div className="p-6">
          <div className={styles.modalHeader}>
            <h3 className={styles.modalTitle}>Crete New Resume</h3>
            <button
        ...
        <div className="p-4">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="bg-red-100 p-4 rounded-full mb-3">
              <LucideTrash2 className="text-red-600" size={28} />
            </div>
            <h3 className="text-md font-medium">Delete Resume</h3>
