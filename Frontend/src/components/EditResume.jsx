...
import { AlertCircle, ArrowLeft, Check, Loader, Save } from "react-feather";
import {
  ProfileInfoForm,
  ContactInfoForm,
  WorkExperienceForm,
...
const EditResume = () => {
  ...
  const updateArrayItem = (section, index, key, value) => {
    setResumeData((prev) => {
      ...
      if (key) {
        ...
        updatedArray[index] = value; // for simple array like interests
      }
  ...
  // fetching the resume details using backend ides
  ...
  //heps in chooseing the preview as well as helps in downloading the resume also saves the resume as image
  ...
  //del function to del any resume
  ...
  const updateTheme = (theme) => {
    setResumeData((prev) => ({
      ...
      template: {
        ...prev.template,
        theme: theme,
        colorPalette: [], // optional, reset if needed
      },
    }));
  };
  ...
  return (
    <DashboarLayout>
      <div className={styles.main}>
        <div className={styles.header}>
          <TitleInput
            ...
            setTitle={(val) =>
              setResumeData((prev) => ({ ...prev, title: val }))
            }
          />
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="flex flex-wrap items-center justify-end gap-3">
                ...
                <button
                  ...
                  disabled={isLoading}
                >
                  {currentPage === "additionalInfo" && <Download size={20} />}
      ...
      >
        ...
        <div className={commonStyles.pdfPreview}>
