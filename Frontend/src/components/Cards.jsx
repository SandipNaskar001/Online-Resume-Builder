    ...
    >
      {thumbnailImg ? (
        <div className="relative w-full h-full overflow-hidden">
          ...
          />
          <div
            className="absolute inset-0 bg-gradient-to-t from-white/10 via-transparent
        to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          ></div>
          {isSelected && (
            <div className="absolute inset-0 bg-blue-500/10 flex items-center justify-center">
              <div
                className="w-16 h-16 bg-white backdrop:blur-sm rounded-full flex
        ...
        <div
          className="w-full h-{200px} flex items-center flex-col
        justify-center bg-gradient-to-br from-blue-50 via-blue-600 to-fuchsia-100"
        >
          <div
            className="w-12 h-12 bg-gradient-to-br from-blue-500 to bg-sky-400 rounded-2xl flex
