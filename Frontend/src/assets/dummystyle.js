export const landingPageStyles = {
  ...
  // Header styles
  header: "fixed top-0 w-full z-50 bg-white/70 backdrop-blur-xl border-b border-blue-100/50",
  ...
  logoIcon: "w-10 h-10 bg-gradient-to-br from-indigo-600 to-cyan-600 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-200",
  logoIconInner: "w-5 h-5 text-white",
  logoText: "text-xl sm:text-2xl font-black bg-gradient-to-r from-indigo-600 to-cyan-600 bg-clip-text text-transparent",
  mobileMenuButton: "md:hidden p-2 rounded-xl hover:bg-blue-50 transition-colors",
  mobileMenuIcon: "text-indigo-600",

  // Auth buttons
  desktopAuthButton: "relative group px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-indigo-600 to-cyan-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-xl hover:shadow-blue-200",
  ...
  mobileDashboardButton: "w-full px-6 py-3 bg-gradient-to-r from-indigo-600 to-cyan-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-blue-200/50 transition-all",
  mobileAuthButton: "w-full px-6 py-3 bg-gradient-to-r from-indigo-600 to-cyan-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-blue-200/50 transition-all",
  // Main content
  main: "pt-24",
  ...
  heroLeft: "space-y-8",
  tagline: "inline-flex items-center gap-2 sm:gap-3 px-4 py-2 bg-gradient-to-r from-blue-100 to-cyan-100 border border-blue-200 text-indigo-700 rounded-full font-bold text-xs sm:text-sm",
  heading: "text-4xl sm:text-6xl lg:text-8xl font-black leading-tight",
  headingText: "block text-slate-900",
  headingGradient: "block bg-gradient-to-r from-indigo-600 via-cyan-600 to-teal-500 bg-clip-text text-transparent",
  ...
  // Buttons
  primaryButton: "group relative px-10 py-4 bg-gradient-to-r from-indigo-600 to-cyan-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-blue-200",
  primaryButtonOverlay: "absolute inset-0 bg-gradient-to-r from-cyan-600 to-teal-500 opacity-0 group-hover:opacity-100 transition-opacity",
  ...
  secondaryButton: "px-8 sm:px-10 py-3 sm:py-4 border-2 border-indigo-200 text-indigo-700 font-bold rounded-2xl hover:border-indigo-300 hover:bg-indigo-50 transition-all",
  ...
  heroIllustrationBg: "absolute -inset-8 bg-gradient-to-r from-blue-200/50 to-indigo-200/50 rounded-3xl blur-3xl",
  ...
  svgRectPrimary: "fill-[#4c51bf]",
  svgRectSecondary: "fill-[#06b6d4]",
  svgRectLight: "fill-[#e2e8f0]",
  svgRectSkill: "fill-[#e0e7ff]",
  svgAnimatedCircle: "fill-[#059669] opacity-80",
  ...
  featureCardHover: "absolute -inset-2 bg-gradient-to-r opacity-0 group-hover:opacity-100 transition-opacity blur-xl rounded-3xl from-blue-200 to-indigo-200",
  ...
  featureCardOrange: "from-teal-50 to-emerald-50",
  ...
  ctaCard: "relative",
  ctaCardBg: "absolute -inset-6 sm:-inset-8 bg-gradient-to-r from-blue-200/50 to-indigo-200/50 rounded-3xl blur-3xl",
  ...
  ctaButton: "group relative px-8 sm:px-12 py-3 sm:py-5 bg-gradient-to-r from-indigo-600 to-cyan-600 text-white font-black text-lg rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-blue-200",
  ctaButtonOverlay: "absolute inset-0 bg-gradient-to-r from-cyan-600 to-teal-500 opacity-0 group-hover:opacity-100 transition-opacity",
  ctaButtonText: "relative",

  // Footer
  footer: "border-t border-blue-100 bg-gradient-to-r from-blue-50 to-cyan-50 py-6 sm:py-8",
...
export const dashboardStyles = {
  ...
  // Create Button
  createButton: "group relative px-10 py-4 bg-gradient-to-r from-indigo-600 to-cyan-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-blue-200",
  createButtonOverlay: "absolute inset-0 bg-gradient-to-r from-cyan-600 to-teal-500 opacity-0 group-hover:opacity-100 transition-opacity",
  ...
  emptyIconWrapper: "bg-indigo-100 p-4 rounded-full mb-4",
  ...
  // New Resume Card
  newResumeCard: "flex flex-col items-center justify-center bg-gradient-to-br from-indigo-50 to-blue-50 border-2 border-dashed border-indigo-300 rounded-2xl p-6 cursor-pointer transition-all hover:shadow-lg hover:border-indigo-500 h-full",
...
export const cardStyles = {
  ...
  resumeCard: "group relative h-[360px] sm:h-[380px] lg:h-[400px] flex flex-col bg-white border border-gray-200 rounded-3xl overflow-hidden cursor-pointer transition-all duration-500 hover:scale-[1.02] hover:shadow-xl hover:border-indigo-300",
  cardBackground: "absolute inset-0 bg-gradient-to-br from-indigo-100 via-transparent to-blue-100 opacity-0 group-hover:opacity-100 transition-opacity duration-500",
  ...
  title: "text-sm sm:text-base font-bold text-gray-800 truncate mb-2 group-hover:text-indigo-600 transition-colors",
  ...
  editButton: "group/btn w-12 h-12 flex items-center justify-center bg-gradient-to-r from-indigo-600 to-cyan-600 rounded-2xl shadow-md hover:scale-110 transition-all duration-300",
  deleteButton: "group/btn w-12 h-12 flex items-center justify-center bg-gradient-to-r from-red-500 to-rose-500 rounded-2xl shadow-md hover:scale-110 transition-all duration-300",
...
export const authStyles = {
  ...
  submitButton: "w-full py-4 bg-gradient-to-r from-indigo-600 to-cyan-600 text-white font-black rounded-2xl hover:scale-105 hover:shadow-xl hover:shadow-blue-200 transition-all text-lg",
  ...
  signupSwitchButton: "font-black text-blue-600 hover:text-cyan-600 transition-colors"
};
...
export const additionalInfoStyles = {
  ...
  dotViolet: "w-2 h-2 bg-gradient-to-r from-indigo-500 to-cyan-500 rounded-full",
  ...
  addButtonLanguage: "bg-gradient-to-r from-indigo-500 to-cyan-500",
  addButtonInterest: "bg-gradient-to-r from-teal-500 to-emerald-500",
};
...
export const educationDetailsStyles = {
  container: "p-8 bg-gradient-to-br from-white to-purple-50",
  heading: "text-2xl font-black text-slate-900 mb-8",
  item: "relative bg-white border border-purple-100 p-6 rounded-2xl shadow-sm hover:shadow-lg transition-all",
  addButton: "bg-gradient-to-r from-blue-700 to-sky-400",
};
...
export const skillsInfoStyles = {
  ...
  heading: "text-2xl font-black text-slate-900 mb-8",
  item: "relative bg-white border border-sky-100 p-6 rounded-2xl shadow-sm hover:shadow-lg transition-all",
  addButton: "bg-gradient-to-r from-sky-500 to-blue-500",
};
...
export const inputStyles = {
  wrapper: "mb-6 group",
  label: "block text-sm font-bold text-gray-800 mb-3 group-focus-within:text-indigo-600 transition-colors",
  ...
  toggleButton: "text-gray-500 hover:text-indigo-600 transition-colors p-1 rounded-lg hover:bg-gray-100",
};

export const photoSelectorStyles = {
  container: "flex justify-center mb-8",
  hiddenInput: "hidden",
  placeholder: hovered => `relative w-32 h-32 sm:w-36 sm:h-36 flex items-center justify-center bg-gray-50 border-2 border-dashed border-gray-300 rounded-full cursor-pointer transition-all duration-300 ${hovered ? 'hover:border-indigo-500 hover:bg-indigo-50' : ''}`,
  ...
  previewImageContainer: hovered => `w-32 h-32 sm:w-36 sm:h-36 rounded-full overflow-hidden border-4 border-gray-200 shadow-lg transition-all duration-300 ${hovered ? 'group-hover:border-indigo-400' : ''}`,
...
export const titleInputStyles = {
  ...
  editIcon: "w-5 h-5 text-gray-600 group-hover:text-indigo-600 transition-colors",
  inputField: focused => `text-lg sm:text-xl font-bold bg-transparent outline-none text-gray-800 border-b-2 pb-2 transition-all duration-300 ${focused ? 'border-indigo-500' : 'border-gray-300'}`,
...
export const modalStyles = {
  ...
  header: "flex items-center justify-between p-6 border-b border-indigo-100 bg-gradient-to-r from-white to-blue-50",
